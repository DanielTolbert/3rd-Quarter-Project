...
//        }
    ...
    /**
     * @return the current cycle ID of the FRCCodexClasses.Codex.  This also matches the
     * number of times FRCCodexClasses.Codex.reset() has been called for this instance.
     */
    public int id() {
        return mId;
    }
    ...
    /**
     * @return a byte array that can be decoded via FRCCodexClasses.CodexMetadata.parse()
     */
    public byte[] encode() {
    ...
    /**
     * @param pEnum The enum that backs the FRCCodexClasses.Codex.
     * @param pData The byte[] array wrapped in a buffer.  Hopefully it was created with the encode() method.
     * @return a FRCCodexClasses.Codex Meta data object, supposing nothing went wrong
     */
     ...
     * @param pEnum The enumeration that backs the FRCCodexClasses.Codex
     * @return a FRCCodexClasses.Codex Metadata object that is initialzed with everything = 0
     */
